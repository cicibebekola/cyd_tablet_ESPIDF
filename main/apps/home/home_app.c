...
void create_home_app(void) {
    ...
    lv_obj_align(wifi_btn, LV_ALIGN_CENTER, -80, 0);
    ...
    lv_obj_align(bt_btn, LV_ALIGN_CENTER, 80, 0);
    ...
    lv_obj_align(folder_btn, LV_ALIGN_BOTTOM_MID, 0, 0);
